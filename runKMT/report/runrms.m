addpath('/home/ocs/matlab/Lizoo'); Doc='/home/ocs/.claude/jobs/010f4e84/tmp/'; AxN='XY';
...
title(TL,[RUN ': residual RMS after position and proper motion, per axis and field'], ...
   'FontWeight','bold','FontSize',15);
exportgraphics(Fh,[Doc RUN '_RMS.png'],'Resolution',150); close(Fh); fprintf('RMS DONE\n');
