function [AllSI,JD] = KMT_pipelineI(RawImageList, Args)
    ...
    arguments
        ...
        Args.TempName                      = '/home/yossishv/KMTdata/ob260058_kmtc/2026/BLG01/subkmtcBLG01I202607*fits';%'subkmtcBLG01I202607*fits';'2023/BLG01/subkmt*.fits';%
    ...
    for Iim = 1:Nim
        AI(Iim).ImageData.Image = double(AI(Iim).ImageData.Image);
    end
    ...
    % filter bad images
        ...
        FlagGoodImages = FlagGoodImages & NotEmptyImage & GoodGlobalBack & NotConstantImage; % & HistOK
