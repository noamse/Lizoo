...
% [LogFile,ResFlag]= ml.scripts.processKMTEventField(192630,'CCDSEC', [106,406,106,406],'JDkey','MIDJD','HistoryKey','HISTORY','CatOffset',[0,0],'SNPrctileRangeRefCat',[80 97],'FieldToAvoid', 'BLG41');
